...
/// useful whenever the payload of an attribute is a piece Rust code
/// (an expression, a path, a type...). We don't want to retrive those
/// piece of Rust code as raw token stream: we want to let Rustc give
