...
From Core Require Import Core (t_marker).
Export Core (t_marker).

From Core Require Import Core (t_option).
Export Core (t_option).

From Core Require Import Core (t_primitive).
Export Core (t_primitive).

From Core Require Import Core_Ops (t_FnMut).
Export Core_Ops (t_FnMut).

Class t_Iterator (v_Self : Type) : Type :=
  {
    Iterator_f_Item : Type;
    _ :: `{t_Sized (Iterator_f_Item)};
