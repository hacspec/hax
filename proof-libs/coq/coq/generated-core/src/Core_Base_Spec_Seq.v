...
Notation "'t_Seq'" := (t_Seq).

Notation "'Seq_f_v'" := (Seq_f_v).

Notation "'impl'" := (impl).

Notation "'t_LIST'" := (t_LIST).

Notation "'LIST_NIL'" := (LIST_NIL).

Notation "'LIST_CONS'" := (LIST_CONS).

Notation "'nil'" := (nil).

Notation "'cons'" := (cons).

Notation "'match_list'" := (match_list).
