...
Definition unchecked_add_u128 (x : t_u128) (y : t_u128) : t_u128 :=
   (Build_t_U128 (impl_6__add (t_Abstraction_f_lift (x)) (t_Abstraction_f_lift (y)))).

Definition unchecked_add_u16 (x : t_u16) (y : t_u16) : t_u16 :=
   (Build_t_U16 (impl_6__add (t_Abstraction_f_lift (x)) (t_Abstraction_f_lift (y)))).

Definition unchecked_add_u32 (x : t_u32) (y : t_u32) : t_u32 :=
   (Build_t_U32 (impl_6__add (t_Abstraction_f_lift (x)) (t_Abstraction_f_lift (y)))).

Definition unchecked_add_u64 (x : t_u64) (y : t_u64) : t_u64 :=
   (Build_t_U64 (impl_6__add (t_Abstraction_f_lift (x)) (t_Abstraction_f_lift (y)))).

Definition unchecked_add_u8 (x : t_u8) (y : t_u8) : t_u8 :=
   (Build_t_U8 (impl_6__add (t_Abstraction_f_lift (x)) (t_Abstraction_f_lift (y)))).
...
Definition add_with_overflow_u128 (x : t_u128) (y : t_u128) : (t_u128*bool) :=
  let overflow := impl_6__add (t_Abstraction_f_lift (x)) (t_Abstraction_f_lift (y)) in
  let res : t_U128 := t_Concretization_f_concretize (t_Clone_f_clone (overflow)) in
  ( (t_Clone_f_clone (res)),t_PartialOrd_f_lt (t_PartialOrd := t_HaxInt_t_PartialOrd) (t_Abstraction_f_lift (res)) (overflow)).
