...
let impl_1__map
      (#v_T #v_U #v_F: Type0)
      (#[FStar.Tactics.Typeclasses.tcresolve ()] i3: Core.Ops.Function.t_FnOnce v_F v_T)
      (self: t_Option v_T)
      (f: v_F)
    : t_Option v_U =
  match self with
  | Option_Some x ->
    Option_Some
    (Core.Ops.Function.f_call_once #v_F #v_T #FStar.Tactics.Typeclasses.solve f (x <: v_T))
    <:
    t_Option v_U
