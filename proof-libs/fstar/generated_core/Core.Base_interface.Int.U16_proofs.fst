...
let int_range (x: Core.Base_interface.Int.t_U16)
    : Lemma Prims.l_True
      (ensures
...
let addA (x y z: Core.Base_interface.Int.t_U16)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U16 #FStar.Tactics.Typeclasses.solve x
            <:
          ...
          <:
          Core.Base_interface.Int.t_U16) =.
        ((x +! y <: Core.Base_interface.Int.t_U16) +! z <: Core.Base_interface.Int.t_U16)) = ()

let addC (x y: Core.Base_interface.Int.t_U16)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U16 #FStar.Tactics.Typeclasses.solve x
            <:
          ...
          <:
          Core.Base_interface.Int.t_U16) =.
        (y +! x <: Core.Base_interface.Int.t_U16)) = ()

let add_0_l (x y z: Core.Base_interface.Int.t_U16)
    : Lemma Prims.l_True
      (ensures
...
let add_0_r (x y z: Core.Base_interface.Int.t_U16)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U16 #FStar.Tactics.Typeclasses.solve x
            <:
...
let div_1_r (x y: Core.Base_interface.Int.t_U16)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U16 #FStar.Tactics.Typeclasses.solve x
            <:
...
let mod_small (x y: Core.Base_interface.Int.t_U16)
    : Lemma Prims.l_True
      (ensures
        (Core.Clone.f_clone #Core.Base_interface.Int.t_U16 #FStar.Tactics.Typeclasses.solve x
          <:
...
let mulA (x y z: Core.Base_interface.Int.t_U16)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U16 #FStar.Tactics.Typeclasses.solve x
            <:
...
let mulC (x y: Core.Base_interface.Int.t_U16)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U16 #FStar.Tactics.Typeclasses.solve x
            <:
...
let mul_1_l (x: Core.Base_interface.Int.t_U16)
    : Lemma Prims.l_True
      (ensures
        ((Core.Base_interface.Int.f_ONE #FStar.Tactics.Typeclasses.solve
            <:
...
let mul_1_r (x: Core.Base_interface.Int.t_U16)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U16 #FStar.Tactics.Typeclasses.solve x
            <:
...
let mul_distr (x y z: Core.Base_interface.Int.t_U16)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U16 #FStar.Tactics.Typeclasses.solve x
            <:
        ...
        (((Core.Clone.f_clone #Core.Base_interface.Int.t_U16 #FStar.Tactics.Typeclasses.solve x
            ...
            <:
            Core.Base_interface.Int.t_U16) +!
          (x *! z <: Core.Base_interface.Int.t_U16)
          <:
          Core.Base_interface.Int.t_U16)) = ()

let mul_opp (x: Core.Base_interface.Int.t_U16)
    : Lemma Prims.l_True
      (ensures
        (Core.Ops.Arith.f_neg #Core.Base_interface.Int.t_U16
            #FStar.Tactics.Typeclasses.solve
            (Core.Clone.f_clone #Core.Base_interface.Int.t_U16 #FStar.Tactics.Typeclasses.solve x
              <:
              Core.Base_interface.Int.t_U16)
...
let neg_idemp (x: Core.Base_interface.Int.t_U16)
    : Lemma Prims.l_True
      (ensures
        (Core.Ops.Arith.f_neg #Core.Base_interface.Int.t_U16
            #FStar.Tactics.Typeclasses.solve
...
let shl_1_ (x: Core.Base_interface.Int.t_U16)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U16 #FStar.Tactics.Typeclasses.solve x
            <:
...
let shr_1_ (x: Core.Base_interface.Int.t_U16)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U16 #FStar.Tactics.Typeclasses.solve x
            <:
...
let addN (x: Core.Base_interface.Int.t_U16)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U16 #FStar.Tactics.Typeclasses.solve x
            <:
...
let sub_distr (x y z: Core.Base_interface.Int.t_U16)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U16 #FStar.Tactics.Typeclasses.solve x
            <:
          ...
          Core.Base_interface.Int.t_U16) =.
        (x +!
          ((Core.Ops.Arith.f_neg #Core.Base_interface.Int.t_U16 #FStar.Tactics.Typeclasses.solve y
              <:
              Core.Base_interface.Int.t_U16) +!
            (Core.Ops.Arith.f_neg #Core.Base_interface.Int.t_U16 #FStar.Tactics.Typeclasses.solve z
              <:
              Core.Base_interface.Int.t_U16)
            <:
            Core.Base_interface.Int.t_U16)
...
let sub_is (x y: Core.Base_interface.Int.t_U16)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U16 #FStar.Tactics.Typeclasses.solve x
            <:
