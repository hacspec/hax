...
let int_range (x: Core.Base_interface.Int.t_U8)
    : Lemma Prims.l_True
      (ensures
...
let addA (x y z: Core.Base_interface.Int.t_U8)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U8 #FStar.Tactics.Typeclasses.solve x
            <:
          ...
          <:
          Core.Base_interface.Int.t_U8) =.
        ((x +! y <: Core.Base_interface.Int.t_U8) +! z <: Core.Base_interface.Int.t_U8)) = ()
...
let add_0_r (x y z: Core.Base_interface.Int.t_U8)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U8 #FStar.Tactics.Typeclasses.solve x
            <:
...
let div_1_r (x y: Core.Base_interface.Int.t_U8)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U8 #FStar.Tactics.Typeclasses.solve x
            <:
...
let mulA (x y z: Core.Base_interface.Int.t_U8)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U8 #FStar.Tactics.Typeclasses.solve x
            <:
...
let mul_1_l (x: Core.Base_interface.Int.t_U8)
    : Lemma Prims.l_True
      (ensures
        ((Core.Base_interface.Int.f_ONE #FStar.Tactics.Typeclasses.solve
            <:
...
let mul_1_r (x: Core.Base_interface.Int.t_U8)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U8 #FStar.Tactics.Typeclasses.solve x
            <:
...
let mul_distr (x y z: Core.Base_interface.Int.t_U8)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U8 #FStar.Tactics.Typeclasses.solve x
            <:
...
let mul_opp (x: Core.Base_interface.Int.t_U8)
    : Lemma Prims.l_True
      (ensures
        (Core.Ops.Arith.f_neg #Core.Base_interface.Int.t_U8
            #FStar.Tactics.Typeclasses.solve
            (Core.Clone.f_clone #Core.Base_interface.Int.t_U8 #FStar.Tactics.Typeclasses.solve x
              <:
              Core.Base_interface.Int.t_U8)
...
let shl_1_ (x: Core.Base_interface.Int.t_U8)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U8 #FStar.Tactics.Typeclasses.solve x
            <:
...
let shr_1_ (x: Core.Base_interface.Int.t_U8)
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U8 #FStar.Tactics.Typeclasses.solve x
            <:
    ...
    : Lemma Prims.l_True
      (ensures
        ((Core.Clone.f_clone #Core.Base_interface.Int.t_U8 #FStar.Tactics.Typeclasses.solve x
          ...
          Core.Base_interface.Int.t_U8) =.
        (x +!
          ((Core.Ops.Arith.f_neg #Core.Base_interface.Int.t_U8 #FStar.Tactics.Typeclasses.solve y
              <:
              Core.Base_interface.Int.t_U8) +!
            (Core.Ops.Arith.f_neg #Core.Base_interface.Int.t_U8 #FStar.Tactics.Typeclasses.solve z
              <:
              Core.Base_interface.Int.t_U8)
            <:
            Core.Base_interface.Int.t_U8)
