...
val get_bit_pow2_minus_one_i32
  ...
  : Lemma ( get_bit (from_int32 (FStar.Int32.int_to_t x)) nth 
        == (if v nth < Some?.v (mask_inv_opt x) then 1 else 0))
  [SMTPat (get_bit (from_int32 (FStar.Int32.int_to_t x)) nth)]
...
val get_bit_pow2_minus_one_i16
  ...
  : Lemma ( get_bit (from_int16 (FStar.Int16.int_to_t x)) nth 
        == (if v nth < Some?.v (mask_inv_opt x) then 1 else 0))
  [SMTPat (get_bit (from_int16 (FStar.Int16.int_to_t x)) nth)]
...
val get_bit_pow2_minus_one_u32
  ...
  : Lemma ( get_bit (from_uint32 (FStar.UInt32.uint_to_t x)) nth 
        == (if v nth < Some?.v (mask_inv_opt x) then 1 else 0))
  [SMTPat (get_bit (from_uint16 (FStar.UInt16.uint_to_t x)) nth)]
...
val get_bit_pow2_minus_one_u16
  ...
  : Lemma ( get_bit (from_uint16 (FStar.UInt16.uint_to_t x)) nth 
        == (if v nth < Some?.v (mask_inv_opt x) then 1 else 0))
  [SMTPat (get_bit (from_uint16 (FStar.UInt16.uint_to_t x)) nth)]
...
val get_bit_pow2_minus_one_u8
  ...
  : Lemma ( get_bit #t (from_uint8 (FStar.UInt8.uint_to_t x)) nth 
        == (if v nth < Some?.v (mask_inv_opt x) then 1 else 0))
  [SMTPat (get_bit #t (from_uint8 (FStar.UInt8.uint_to_t x)) nth)]
