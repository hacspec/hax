...
(() => {
    console.log(1234);
    for(let o of document.querySelectorAll('strong')) {
        console.log(1234);
        if(o.innerText != 'user-checkable')
            continue;
        let node = document.createElement('input');
        node.type = 'checkbox';
        node.classList.add('user-checkable-checkbox');
        o.parentElement.replaceChild(node, o);
    }
})();
