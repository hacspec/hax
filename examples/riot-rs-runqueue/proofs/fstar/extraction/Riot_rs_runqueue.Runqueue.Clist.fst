...
let impl__new (#v_N_QUEUES #v_N_THREADS: usize) : t_CList #v_N_QUEUES #v_N_THREADS =
  {
    ...
    f_next_idxs = Rust_primitives.Hax.repeat (impl__sentinel #v_N_QUEUES #v_N_THREADS  <: u8) v_N_THREADS
  }

let impl__is_empty (#v_N_QUEUES #v_N_THREADS: usize) (self: t_CList #v_N_QUEUES #v_N_THREADS) (rq: u8)
    : bool = (self.f_tail.[ admit();cast_mod rq <: usize ] <: u8) =. (impl__sentinel #v_N_QUEUES #v_N_THREADS <: u8)
...
let impl__push (#v_N_QUEUES #v_N_THREADS: usize) (self: t_CList #v_N_QUEUES #v_N_THREADS) (n rq: u8)
  ...
  let self, output:(t_CList #v_N_QUEUES #v_N_THREADS & Prims.unit) =
    if (self.f_next_idxs.[ admit();cast n <: usize ] <: u8) =. (impl__sentinel #v_N_QUEUES #v_N_THREADS<: u8)
    then
      if (self.f_tail.[ cast rq <: usize ] <: u8) =. (impl__sentinel #v_N_QUEUES #v_N_THREADS <: u8)
      then
        let self:t_CList #v_N_QUEUES #v_N_THREADS =
          {
            ...
            f_tail
            =
            Rust_primitives.Hax.update_at self.f_tail
              (cast rq <: usize)
              n
          }
        in
        let self:t_CList #v_N_QUEUES #v_N_THREADS =
          {
            ...
            f_next_idxs
            =
            Rust_primitives.Hax.update_at self.f_next_idxs
              (cast n <: usize)
              n
          }
        in
...
let impl__pop_head (#v_N_QUEUES #v_N_THREADS: usize) (self: t_CList #v_N_QUEUES #v_N_THREADS) (rq: u8)
  ...
  let self, output:(t_CList #v_N_QUEUES #v_N_THREADS & Core.Option.t_Option u8) =
    if (self.f_tail.[ admit();cast rq <: usize ] <: u8) =. (impl__sentinel #v_N_QUEUES #v_N_THREADS<: u8)
