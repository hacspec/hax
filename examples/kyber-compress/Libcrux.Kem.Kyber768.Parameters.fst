...
//   v_RANK *. v_COEFFICIENTS_IN_RING_ELEMENT *. v_BITS_PER_COEFFICIENT /. 8sz
...
//   v_COEFFICIENTS_IN_RING_ELEMENT *. v_VECTOR_U_COMPRESSION_FACTOR /. 8sz

// let v_VECTOR_U_ENCODED_SIZE: usize = v_RANK *. v_BYTES_PER_ENCODED_ELEMENT_OF_U

// let v_VECTOR_V_ENCODED_SIZE: usize =
//   v_COEFFICIENTS_IN_RING_ELEMENT *. v_VECTOR_V_COMPRESSION_FACTOR /. 8sz
...
// 0sz
//   // v_CPA_PKE_SECRET_KEY_SIZE +. (v_CPA_PKE_PUBLIC_KEY_SIZE +.
//   // (32sz +.
//   // (v_CPA_PKE_MESSAGE_SIZE <: usize)) <: usize) <: usize
