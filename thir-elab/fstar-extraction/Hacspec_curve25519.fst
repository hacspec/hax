...
let point_add_and_double
  ...
  let b:x25519FieldElement_t = Core.Ops.Arith.Sub.sub x_2 z_2 in
  let bb:x25519FieldElement_t = b *. b in
  let e:x25519FieldElement_t = Core.Ops.Arith.Sub.sub aa bb in
  let c:x25519FieldElement_t = x_3 +. z_3 in
  let d:x25519FieldElement_t = Core.Ops.Arith.Sub.sub x_3 z_3 in
  let da:x25519FieldElement_t = d *. a in
  let cb:x25519FieldElement_t = c *. b in
  let x_3:x25519FieldElement_t = pow (da +. cb) (pub_u128 2) in
  let z_3:x25519FieldElement_t = x_1 *. pow (Core.Ops.Arith.Sub.sub da cb) (pub_u128 2) in
